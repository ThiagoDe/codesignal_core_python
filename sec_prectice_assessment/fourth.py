...
# queryTypes contains the names of the methods to be called(eg: insert, get, etc), and queries 
# contains the arguments for those methods(the x and y values).
# Your task is to implement this hashmap, apply the given queries, and to find the sum of all the
# results for get operations.
# Example
# * For queryType = ["insert", "insert", "addToValue", "addToKey", "get"] and query = [[1, 2], [2, 3], [2], [1], [3]], the output should be solution(queryType, query) = 5. The hashmap looks like this after each query:
#     * 1 query: {1: 2}
#     * 2 query: {1: 2, 2: 3}
#     * 3 query: {1: 4, 2: 5}
#     * 4 query: {2: 4, 3: 5}
...
# ￼
# * For queryType = ["insert", "addToValue", "get", "insert", "addToKey", "addToValue", "get"] and query = [[1, 2], [2], [1], [2, 3], [1], [-1], [3]], the output should be solution(queryType, query) = 6. The hashmap looks like this after each query:
#     * 1 query: {1: 2}
#     * 2 query: {1: 4}
#     * 3 query: answer is 4
#     * 4 query: {1: 4, 2: 3}
